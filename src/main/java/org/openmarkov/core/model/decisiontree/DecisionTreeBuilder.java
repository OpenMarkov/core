...
public class DecisionTreeBuilder {
    ...
    // ((DecisionTreeBranch) root).setChild((DecisionTreeNode)
    // buildDecisionTreeFromDAN(probNet, probNet));
    // }
    // return root;
    // }
    //
    // private static DecisionTreeElement buildDecisionTreeFromDAN(ProbNet
    // originalProbNet, ProbNet probNet) {
    // DecisionTreeElement root = null;
    // //TODO Uncomment next line when it is possible to invoke the constructor of
    // DANDecisionTreeEvaluation from here.
    ...
    // getAlwaysObservedVariablesWithoutObservableParents(ProbNet probNet) {
    // List<Node> alwaysObservedVariables =
    ...
    // noObservedParent = !probNet.isParent(alwaysObservedVariables.get(i),
    // alwaysObservedVariable);
    // ++i;
    // }
    // if (noObservedParent)
    ...
    // DecisionTreeBranch treeBranch = new DecisionTreeBranch(dtProbNet, variable,
    // state);
    ...
    // Variable branchVariable = ((DecisionTreeBranch)
    // treeElement).getBranchVariable();
    ...
    // DecisionTreeNode child = new
    // DecisionTreeNode(dtProbNet.getNode(childVariable));
    ...
    // }
    // svNode.addPotential(new SumPotential(leafVariables,
    ...
    //
    // /**
    // * Using PartialOrder generates a sorted plain list of decision and chance
    // variables
    // *
    ...
    // variables = new ArrayList<>(BasicOperations.getNumVariables(probNet));
    // //(partialOrder.getNumVariables ());
    // for (Collection<Variable> variableSubList : partialOrder)
    // //partialOrder.getOrder ())
    // {
