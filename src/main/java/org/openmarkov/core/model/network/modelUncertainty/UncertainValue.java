...
public class UncertainValue
{
    ...
    public UncertainValue (TypeProbDensityFunction type,
                           String arguments,
                           String name,
                           boolean createSSJPDF,
                           boolean createRandomGenerator)
    {
        this.name = name;
        ...
        else
        {
            ...
            /*
             * if (createSSJPDF){ auxProb.createSSJPDF(); } if
             * (createRandomGenerator){ auxProb.createRandomGenerator(); }
             */
        }
    ...
    public void setCorrectArgumentsInProbDensFunction (boolean correctArgumentsInProbDensFunction)
    {
    ...
    /*
     * private static boolean isCharacterAllowedInNumber(String c) { // TODO
