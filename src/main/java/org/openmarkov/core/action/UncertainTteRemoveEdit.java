...
/**
 *
 * @version 1.0 -cyago- 25/03/2019
 */

@SuppressWarnings("serial") public class UncertainTteRemoveEdit extends SimplePNEdit {
	 ...
	 * @param configuration
	 */
	public UncertainTteRemoveEdit(Node node, EvidenceCase configuration) {
