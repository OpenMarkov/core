...
public class DirichletFamilyTest extends FamilyDistributionTest {
	...
	/* (non-Javadoc)
	 * @see org.openmarkov.core.model.network.modelUncertainty.FamilyDistributionTest#getTypeProbDensFunction()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.openmarkov.core.model.network.modelUncertainty.FamilyDistributionTest#initializeListUncertainValues()
	 */
	@Override
