...
public class DecisionTreeTest {
	...
	@Ignore("Ignored because an AssertionFailedError") @Test public void testDecideTestID() {
	...
	@Ignore("Ignored because an Exception") @Test public void testDecideTestDAN() throws NodeNotFoundException {
	...
	@Ignore("Ignored because an Exception") @Test public void testDatingDAN() throws NodeNotFoundException {
	...
	@Ignore("Ignored because an Exception") @Test public void testReactorDAN() throws NodeNotFoundException {
	...
	@Ignore("Ignored because an Exception") @Test public void testDiabetesDAN() throws NodeNotFoundException {
	...
	@Ignore("Ignored because an Exception") @Test public void testTwoTestsDAN() throws NodeNotFoundException {
		ProbNet diabetesDAN = DANFactory.buildTwoTestDAN();
		DecisionTreeElement decisionTree = DecisionTreeBuilder.buildDecisionTree(diabetesDAN);
		Assert.assertEquals(9.3324, decisionTree.getUtility(), 0.0001);
	}

	@Ignore("Ignored because an Exception") @Test public void testNtests()
	...
	@Ignore("Ignored because an AssertionFailedError") @Test public void testEvalDecideTestDAN()
	...
	@Ignore("Ignored because an AssertionFailedError") @Test public void testEvalDatingDAN()
			throws NodeNotFoundException {
		ProbNet datingDAN = DANFactory.buildDatingDAN();
		long startTime = System.nanoTime();
		DecisionTreeEvaluator evaluator = new DecisionTreeEvaluator();
	...
	@Ignore("Ignored because an AssertionFailedError") @Test public void testEvalReactorDAN()
			throws NodeNotFoundException {
		ProbNet reactorDAN = DANFactory.buildReactorDAN();
		long startTime = System.nanoTime();
		DecisionTreeEvaluator evaluator = new DecisionTreeEvaluator();
	...
	@Ignore("Ignored because an AssertionFailedError") @Test public void testEvalDiabetesDAN()
			throws NodeNotFoundException {
		ProbNet diabetesDAN = DANFactory.buildDiabetesDAN();
		long startTime = System.nanoTime();
		DecisionTreeEvaluator evaluator = new DecisionTreeEvaluator();
	...
	@Ignore("Ignored because an AssertionFailedError") @Test public void testEvalTwoTestsDAN()
			throws NodeNotFoundException {
	...
	@Ignore("Ignored because an AssertionFailedError") @Test public void testEvalKingDAN()
			throws NodeNotFoundException {
	...
	@Ignore("Ignored because an AssertionFailedError") @Test public void testEvalNtests()
			throws NodeNotFoundException, IncompatibleEvidenceException, UnexpectedInferenceException,
			NotEvaluableNetworkException {
	...
	@Ignore("Interesting test to keep but it takes to long to execute every time") @Test public void testEvalMediastiNetDAN()
			throws NodeNotFoundException, IncompatibleEvidenceException, UnexpectedInferenceException,
			NotEvaluableNetworkException {
