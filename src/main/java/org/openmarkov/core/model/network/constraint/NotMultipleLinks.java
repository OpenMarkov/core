...
public class NotMultipleLinks implements PNConstraint {

	
private static NotMultipleLinks constraint=null;
	
	// Methods
	/** Singleton pattern.
	 * @return The unique instance. 
	 *  <code>NotMultipleLinks</code> */
	public static PNConstraint getUniqueInstance() {
		if (constraint == null) {
			constraint = new NotMultipleLinks();
		}
		return constraint;
	}
