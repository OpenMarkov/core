 ...
 *
 */
@PotentialType(name = "Piecewise Exponential") public class PiecewiseExponentialPotential extends Potential implements DESSimulablePotential {
...
//	}
	...
	public double sampleConditionedVariable(double[] randomNumbers, EvidenceCase parents) throws OpenMarkovException {
		...
		if (initValue < piecewiseTable.firstKey()){
			throw new OpenMarkovException("Piecewise Exponential: initValue lower than first value in timetable");
		}
...
//	}
	...
	/**
	 * TreeMap with pairs <lower_bound_interval, probability_per_time_unit></lower_bound_interval>
	 */
