...
public enum PurposeType {
	...
	TERMINAL_EVENT("terminalEvent"),INITIAL_EVENT("initialEvent"), COST("cost"), EFFECTIVENESS("effectiveness"), TREATMENT("treatment"),
	RISK_FACTOR("riskfactor"), SYMPTOM("symptom"), SIGN("sign"), TEST("test"),DISEASE_ANOMALY("diseaseanomaly"), AUXILIARY("auxiliary"), OTHER("other") ;
