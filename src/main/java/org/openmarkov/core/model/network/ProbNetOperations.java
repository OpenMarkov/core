...
public class ProbNetOperations {
     ...
     */
    public static void projectEvidence(ProbNet probNet, EvidenceCase evidence) throws NonProjectablePotentialException {
     ...
     */
    public static ProbNet convertNumericalVariablesToFS(ProbNet probNet, EvidenceCase evidence) throws NonProjectablePotentialException, IncompatibleEvidenceException.EvidenceIsIncompatibleWithOther {
        ...
        for (Node node : sortedNodes) {
            ...
            } else if (!node.getPotentials().isEmpty() && doesPotentialContainAnyConvertedNode(node.getPotentials()
                                                                                                   .get(0),
    ...
    public static ProbNet convertNumericalVariablesToFS(ProbNet probNet) throws NonProjectablePotentialException, IncompatibleEvidenceException.EvidenceIsIncompatibleWithOther {
    ...
    public static void sumProjectedPotential(TablePotential potential, TablePotential projectedPotential,
                                             List<Variable> projectedVariables, int[] projectedIndices) throws IncompatibleEvidenceException.EvidenceIsIncompatibleWithOther {
