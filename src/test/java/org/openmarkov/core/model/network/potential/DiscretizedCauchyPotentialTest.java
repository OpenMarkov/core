...
public class DiscretizedCauchyPotentialTest {
    ...
    public void setUp()
    {
        ...
        LinearCombinationPotential medianPotential = new LinearCombinationPotential(parentVariables, PotentialRole.CONDITIONAL_PROBABILITY);
        medianPotential.setCoefficients(new double[] {0, 1, 0.1, -0.2, 0.05});
        LinearCombinationPotential scalePotential = new LinearCombinationPotential(parentVariables, PotentialRole.CONDITIONAL_PROBABILITY);
