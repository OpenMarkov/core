...
@SuppressWarnings("serial") public final class InvertLinkEdit extends BaseLinkEdit {
    ...
    @Override public void checkConstraintsWillBeMet() throws ConstraintViolatedException {
        if (probNet.getConstraintOfClass(DistinctLinks.class) instanceof DistinctLinks constraint) {
            ...
            if (!DistinctLinks.checkLink(probNet, node2, node1, directed)) {
                throw new ConstraintViolatedException.LinkAlreadyExists(constraint, node2, node1);
            }
        }
        ...
        if (probNet.getConstraintOfClass(ModelNetworkConstraint.class) instanceof ModelNetworkConstraint constraint
            ...
            throw new ConstraintViolatedException.ModelDoesntAllowInvertingLink(constraint, this.getVariable1(), this.getVariable2());
        }
    }
	/**
	 *
    ...
    @Override
    public void doEdit(ProbNet probNet) throws ConstraintViolatedException, DoEditException.CannotInvertLink {
