...
public class OnlyTemporalVariables implements PNConstraint{

private static OnlyTemporalVariables constraint=null;
	
	// Methods
	/** Singleton pattern.
	 * @return The unique instance. 
	 *  <code>OnlyTemporalVariables</code> */
	public static PNConstraint getUniqueInstance() {
		if (constraint == null) {
			constraint = new OnlyTemporalVariables();
		}
		return constraint;
	}
