/*
* Copyright 2016 CISIAD, UNED, Spain
*
 ...
 */
@PotentialType(name = "Discretized Cauchy")
public class DiscretizedCauchyPotential extends Potential {
...
//    }
    ...
    public DiscretizedCauchyPotential(List<Variable> variables,
                                      PotentialRole role) {
    ...
    public void setMedian(Potential median) { this.median = median; }
    ...
    public List<TablePotential> tableProject(EvidenceCase evidenceCase,
        ...
        if (unobservedVariables.isEmpty()) {// Projection = constant potential
            ...
            TablePotential projectedMedianPotential = median.tableProject(evidenceCase, inferenceOptions, projectedPotentials).get(0);
            TablePotential projectedScalePotential = scale.tableProject(evidenceCase, inferenceOptions, projectedPotentials).get(0);
            ...
            for (int configuration = 0; configuration < numConfigurations; configuration++) {
                ...
                org.apache.commons.math3.distribution.CauchyDistribution
                        dist = new  org.apache.commons.math3.distribution.CauchyDistribution(median, scale);
                double lastCdf = 0;
    ...
    private Potential getDefaultScalePotential()
    {
        ...
        TablePotential scalePotential = new TablePotential(scalePotentialVariables, PotentialRole.CONDITIONAL_PROBABILITY);
