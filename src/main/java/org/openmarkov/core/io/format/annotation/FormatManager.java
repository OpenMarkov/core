...
//	} 
	 ...
	 * @param extension 
	 * 			- the extension corresponding to the enconding of the file (elv, pgmx)
	 * @param fileFormat 
	 ...
	 */
	public ProbNetWriter getProbNetWriter (String extension, String fileFormat) throws IllegalAccessException, InstantiationException
	{
	    ProbNetWriter instance = null;
	    String version="";
...
//	} 
	 ...
	 * @param version 
	 *             - the version of the ProbModel required
