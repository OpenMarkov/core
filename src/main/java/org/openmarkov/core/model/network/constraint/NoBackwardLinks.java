...
public class NoBackwardLinks implements PNConstraint {

	
private static NoBackwardLinks constraint=null;
	
	// Methods
	/** Singleton pattern.
	 * @return The unique instance. 
	 *  <code>NoBackwardLinks</code> */
	public static PNConstraint getUniqueInstance() {
		if (constraint == null) {
			constraint = new NoBackwardLinks();
		}
		return constraint;
	}
