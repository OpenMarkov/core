...
/**
 * Utility class for evaluating decision trees.
 * Provides methods for calculating MEU (Maximum Expected Utility) and resolving
 * the tree.
 */
public class DecisionTreeEvaluator {

    // private static ProbNet instantiate(ProbNet probNet, Node node, State state,
    // ProbNet originalProbNet) {
    ...
    // instantiatedNet.getNode(link.getNode2().getVariable());
    //
    // // Remove link between restricting node and restricted node
    // instantiatedNet.removeLink(link.getNode1().getVariable(),
    // link.getNode2().getVariable(), true);
    //
    ...
    // // If it has predecessor decisions, do not reveal it yet, but add revealing
    // links
    ...
    // State[] predecessorDecisionStates =
    // predecessorDecision.getVariable().getStates();
    ...
    // }
    //
    // // }else if(nonRestrictedStates.size () == 1) // Remove variables with a
    // single variable
    // // {
    // // ProbNet probNetWithoutSingleStateVariable = probNetCopy.copy ();
    // // probNetWithoutSingleStateVariable.removeNode
    // (probNetWithoutSingleStateVariable.getNode (destinationNode.getVariable ()));
    // // probNetCopy =
    // applyRestrictionsAndReveal(probNetWithoutSingleStateVariable,
    // destinationNode, nonRestrictedStates.get (0), originalProbNet);
    ...
    // Variable restrictedVariable = new
    // Variable(destinationNode.getVariable().getName(),
    // unrestrictedStates);
    ...
    // // Node newNode = probNetCopy.addNode(restrictedVariable,
    // destinationNode.getNodeType());
    ...
    // }
    //
    // private DecisionTreeNode resolve(ProbNet probNet, ProbNet originalProbNet,
    ...
    // Variable originalVariable = getOriginalVariable(alwaysObservedVariable,
    // originalProbNet);
    ...
    // int originalState =
    // originalVariable.getStateIndex(alwaysObservedVariable.getStates()[i]);
    // treeNode = new DecisionTreeNode(originalVariable, originalState, parentNode);
    // ProbNet restrictedProbNet = instantiate(probNet, alwaysObservedNode, state,
    // originalProbNet);
    // DecisionTreeNode node = resolve(restrictedProbNet, originalProbNet,
    // treeNode);
    // // Join
    ...
    // treeNode.setUtility((scenarioProbability != 0) ? utility /
    // scenarioProbability : 0);
    // root = treeNode;
    // } else {
    // List<Node> parentlessDecisions =
    // DecisionTreeBuilder.getNextDecisions(probNet);
    ...
    // Variable originalVariable = getOriginalVariable(decisionVariable,
    // originalProbNet);
    // for (int i = 0; i < decisionVariable.getNumStates(); ++i) {
    // State state = decisionVariable.getStates()[i];
    // int originalState =
    // originalVariable.getStateIndex(decisionVariable.getStates()[i]);
    // treeNode = new DecisionTreeNode(originalVariable, originalState, parentNode);
    // ProbNet restrictedProbNet = instantiate(probNet, decisionNode, state,
    // originalProbNet);
    // DecisionTreeNode node = resolve(restrictedProbNet, originalProbNet,
    // treeNode);
    ...
    // Variable originalVariable = getOriginalVariable(neverObservedVariable,
    // originalProbNet);
    ...
    // int originalState =
    // originalVariable.getStateIndex(neverObservedVariable.getStates()[i]);
    // treeNode = new DecisionTreeNode(originalVariable, originalState, parentNode);
    ...
    // HashMap<Variable, Integer> scenarioMap = getScenarioMap(originalProbNet,
    // parentNode);
    // root.setProbability(getScenarioProbability(originalProbNet, parentNode,
    // scenarioMap));
    ...
    // }
    //
    // private Variable getOriginalVariable(Variable variable, ProbNet
    // originalProbNet) {
    ...
    // }
    //
    // private double getUtility(ProbNet probNet, HashMap<Variable, Integer>
    // scenarioMap) {
    ...
    // }
    //
    // private double getScenarioProbability(ProbNet originalProbNet,
    // DecisionTreeNode parentNode,
    // HashMap<Variable, Integer> scenarioMap) throws InvalidStateException,
    // IncompatibleEvidenceException {
    // List<Potential> parentPotentials = getScenarioPotentials(originalProbNet,
    // parentNode);
    ...
    // }
    //
    // private List<Potential> getScenarioPotentials(ProbNet probNet,
    ...
    // }
    //
    // private HashMap<Variable, Integer> getScenarioMap(ProbNet probNet,
    // DecisionTreeNode parentNode)
    ...
    // }
    //
    // public DecisionTreeNode(Variable variable, int state, DecisionTreeNode
    // parentNode) {
