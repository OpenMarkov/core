...
public abstract class FamilyDistributionTest {
	...
	private FamilyDistribution constructAndInitializeNewFamilyDistributions() {
		...
		FamilyDistribution fam = FamilyDistribution.constructNewFamilyDistributions(list,getTypeProbDensFunction());
		return fam;
	}
	 ...
	 * @param maxErrorMean2
	 */
	private void assertMeanTest(double[] meanSample, double[] meanFamily,
			double maxErrorMean2) {
	 ...
	 * 
	 */
	private void initializeAndPlaceParamsProbDensFunctionTest() {
		// TODO Auto-generated method stub
