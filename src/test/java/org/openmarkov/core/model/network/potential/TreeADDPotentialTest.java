...
public class TreeADDPotentialTest {
	...
	private NetworkTypeConstraint networkTypeConstraint;
    ...
    public void setUp() throws Exception {
		...
		networkConstraint = SMMConstraint.getUniqueInstance() ;
		probNet = new ProbNet((NetworkTypeConstraint)networkConstraint);
