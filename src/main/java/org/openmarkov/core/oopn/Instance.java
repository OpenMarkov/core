...
public class Instance {
    ...
    public enum ParameterArity {
        ...
        public static @Nullable ParameterArity parseArity(String name) {
            if (name.equals(ParameterArity.ONE.toString())) {
                return ParameterArity.ONE;
            }
            if (name.equals(ParameterArity.MANY.toString())) {
                return ParameterArity.MANY;
            }
            return null;
        }
    }
